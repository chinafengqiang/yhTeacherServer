...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/system/MS/js/courseCategory.js"></script>
	</head>
			...
			<div id="mainPage" class="content_box">
				...
				<div id="pageDataList">
					...
					<table class="right_table mart12">
						<thead><tr><th>课程分类</th><th width="36%" class="fillet">操作</th></tr></thead>
				...
				<div id="pageCategoryEditData" style="display: none;"><jsp:include page="courseCategoryEdit.jsp" flush="true"></jsp:include></div>
			</div>
