...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/system/MS/js/examMonitoring.js"></script>
	</head>
			...
			<div id="mainPage" class="content_box">
				...
				<div id="pageDataList">
					...
					<table class="right_table mart12">
						<thead>
							<tr><th>考试服务器</th><th width="120px">状态</th><th width="100px">总人数</th><th width="100px">待考</th><th width="100px">在考</th><th width="100px">已考</th></tr>
						</thead>
					...
					<!-- 按钮区域  -->
					<div class="fl page">
						<input id="btnDeployExam" class="option_btn mart24 marr20" type="button" value="部署">
						<input id="btnOpenExam" class="option_btn mart24 marr20" type="button" value="启动">
						<input id="btnCloseExam" class="option_btn mart24 marr20" type="button" value="停止">
						<input id="btnGatherExam" class="option_btn mart24 marr20" type="button" value="汇总成绩">
						<input id="btnDestroyExam" class="option_btn mart24 marr20" type="button" value="卸载">
					</div>

				</div>
				
				<!-- 返回按钮  -->
				<div class="txtc" style="clear:both;"><input class="option_btn mart45" type="button" value="返&nbsp;&nbsp;&nbsp;回" onclick="window.parent.queryDataList();window.parent.backFromSubPage();" /></div>
			</div>
