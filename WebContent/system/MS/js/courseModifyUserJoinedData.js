...
var actionSaveSelectedDataList = contextPath + "/Course/modifyUserJoinedData.action";
...
$(function() {
	...
	//获取父页面传递过来的参数
	argCourseId = PageUtility.getRequestParam('courseId');
...
function initPage() {
	...
	$("#functionName").html("<span>课程</span>您正在安排参与课程学习的单位……");
