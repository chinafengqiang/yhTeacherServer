...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/jquery/jquery.json-2.4.js"></script>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/system/MS/js/testPaper.js"></script>
	</head>
				...
				<div id="mainPage" class="content_box">
					...
					<div id="pageDataList">
						...
						<table class="right_table mart12">
							<thead>
								<tr><th width="50px">编号</th><th width="100px">分类</th><th>试卷名称</th><th width="60px">出题套数</th><th width="60px">总分数</th><th width="60px">通过分数</th><th width="60px">状态</th><th width="220px" class="fillet">操作</th></tr>
							</thead>
					...
					<!-- 编辑区域  -->
					<div id="pageEditData" style="display: none;"><jsp:include page="testPaperEdit.jsp" flush="true"></jsp:include></div>
					<div id="pageSendData" style="display: none;"><jsp:include page="testPaperSend.jsp" flush="true"></jsp:include></div>
				</div>
			</div>
		</div>
	</body>
