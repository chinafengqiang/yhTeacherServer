...
//                    kgen.init(128, new SecureRandom(password.getBytes("utf-8")));
    ...
    public static String encryptText(String text, String password) {
    	...
    	try {
    		byte[] encryptResult = encrypt(text, password);
    ...
    public static String decryptText(String text, String password) {
    	...
    	try {
            byte[] decryptFrom = parseHexStr2Byte(text);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("加密后：" + encryptText(content, password));
        System.out.println("解密后：" + decryptText(encryptText(content, password), password));
