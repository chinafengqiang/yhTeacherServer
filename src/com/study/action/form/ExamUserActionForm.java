 ...
 * 考试 ActionForm
 */
public class ExamUserActionForm extends BaseActionForm {
	...
	public void setEsExamUserData(String esExamUserData) {
		this.esExamUserData = esExamUserData;
	}

	public String getEsExamUserData() {
		return esExamUserData;
	}
}
